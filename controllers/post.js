...
function getOnePost(req, res) {
  ...
  const q =
    "SELECT p.id, `username`, `title`, `desc`, `authorname`, `authorrole`, `authorimg`, p.postimg, u.img AS userImg, `cat`,`likes`, `date` FROM users u JOIN posts p ON u.id = p.uid WHERE p.id = ? ";
